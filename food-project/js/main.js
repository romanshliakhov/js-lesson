window.addEventListener('DOMContentLoaded', () => {
    ...
    // Первий вариант создарния динамических элементов на странице
    ...
    // Второй вариант создарния без формирования классов, а формирует верстку сразу на лету
    // getResource('http://localhost:3000/menu')
